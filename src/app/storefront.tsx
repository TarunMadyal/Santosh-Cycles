...
const copy = {
  en: {
    ...
    addressShort: "MG Road, near Head Post Office, Haveri – 581110",
    ...
    reasons: [
      ...
      { title: "Easy to reach", body: "Call, WhatsApp or visit us on MG Road near Head Post Office in Haveri." },
    ],
    visitEyebrow: "Visit the store",
    visitTitle: "Santosh Cycles, MG Road, near Head Post Office, Haveri",
  ...
  kn: {
    ...
    addressShort: "ಎಂ.ಜಿ. ರಸ್ತೆ, ಮುಖ್ಯ ಅಂಚೆ ಕಚೇರಿ ಹತ್ತಿರ, ಹಾವೇರಿ – 581110",
    ...
    reasons: [
      ...
      { title: "ಸುಲಭ ಸಂಪರ್ಕ", body: "ಕರೆ, ವಾಟ್ಸಾಪ್ ಅಥವಾ ಹಾವೇರಿಯ ಮುಖ್ಯ ಅಂಚೆ ಕಚೇರಿ ಹತ್ತಿರದ ಎಂ.ಜಿ. ರಸ್ತೆಯ ಅಂಗಡಿಗೆ ಭೇಟಿ ನೀಡಿ." },
    ],
    visitEyebrow: "ಅಂಗಡಿಗೆ ಭೇಟಿ ನೀಡಿ",
    visitTitle: "ಸಂತೋಷ್ ಸೈಕಲ್ಸ್, ಎಂ.ಜಿ. ರಸ್ತೆ, ಮುಖ್ಯ ಅಂಚೆ ಕಚೇರಿ ಹತ್ತಿರ, ಹಾವೇರಿ",
    hours: "ವ್ಯಾಪಾರದ ಸಮಯ",
